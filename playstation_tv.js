...
new page.Route(plugin.id + ":start", function(page) {
   ...
   page.appendItem("", "separator", {
	...
	if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/PlaystationTV/animes.m3u:Animes', "directory", {
            title: 'Animes',
	...
	if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/PlaystationTV/cartoons.m3u:Cartoons', "directory", {
            title: 'Desenhos',
    ...
    if (!service.disableSampleList) {
			page.model.contents = 'grid';
		var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/PlaystationTV/movies.m3u:Movies', "directory", {
            title: 'Filmes',
    ...
    if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/PlaystationTV/series.m3u:Series', "directory", {
            title: 'Séries',
	...
	if (!service.disableSampleXMLList) {
	 	page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/PlaystationTV/music.m3u:Music', "directory", {
            title: 'Música',
	...
	if (!service.disableSampleList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/PlaystationTV/iptv.m3u:IPTV', "directory", {
            title: 'TV',
