...
new page.Route(plugin.id + ":start", function(page) {
   ...
   page.appendItem("", "separator", {
	...
	if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:http://dl.dropboxusercontent.com/s/7ycw1pmls3h6hi0/animes.m3u:Animes', "directory", {
            title: 'Animes',
	...
	if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:http://dl.dropboxusercontent.com/s/618etbxu4eqntxu/cartoons.m3u:Cartoons', "directory", {
            title: 'Desenhos',
    ...
    if (!service.disableSampleList) {
			page.model.contents = 'grid';
		var item = page.appendItem('m3u:http://dl.dropboxusercontent.com/s/1858dqqyrly3gvr/movies.m3u:Movies', "directory", {
            title: 'Filmes',
    ...
    if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:http://dl.dropboxusercontent.com/s/ki90jzfqo9e7yx7/series.m3u:Series', "directory", {
            title: 'Séries',
	...
	if (!service.disableSampleXMLList) {
	 	page.model.contents = 'grid';
        var item = page.appendItem('m3u:http://dl.dropboxusercontent.com/s/uvnxvzgkl9hss1z/music.m3u:Music', "directory", {
            title: 'Música',
	...
	if (!service.disableSampleList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:http://dl.dropboxusercontent.com/s/nzfeg3wmr9c8cfk/iptv.m3u:IPTV', "directory", {
            title: 'TV',
